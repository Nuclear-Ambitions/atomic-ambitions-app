          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="space-y-6 text-muted-foreground leading-relaxed">
              <p>
                ...
                truths. We want to help people feel good about relying on atomic
                energy to improve the quality of life for everyone.
              </p>
              <p>
                Anyone who wants to make a positive global impact should support
                the productive use of atomic energy. Through exploration,
                education, and open-minded discussion, we want to help people
                form a rational view of this infinite source of energy.
              </p>
            </div>
