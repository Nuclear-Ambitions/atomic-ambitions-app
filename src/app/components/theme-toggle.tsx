  ...
  return (
    <button
      ...
      {theme === "light" ? (
        ...
        <svg
          className="w-6 h-6 text-graphite group-hover:text-cherenkov transition-colors"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        ...
        <svg
          className="w-6 h-6 text-uranium group-hover:text-cherenkov transition-colors"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
          xmlns="http://www.w3.org/2000/svg">
